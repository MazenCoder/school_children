                            ...
                            return Container(
                              ...
                              child: new Table(
                                children: [
                                  TableRow(children: [
                                    new Text(
                                      '${getType(snapshot.data[index]['type'].toString().trim())}',
                                      textAlign: TextAlign.center,
                                    ),
                                    new Text(
                                      '${snapshot.data[index]['niveau']}',
                                      textAlign: TextAlign.center,
                                    ),
                                    new Text(
                                      '${snapshot.data[index]['date_debut']}',
                                      textAlign: TextAlign.center,
                                    ),
                                    new Text(
                                      '${snapshot.data[index]['date_fin']}',
                                      textAlign: TextAlign.center,
                                    ),
                                  ]),
                                ],
                                ...
                                border:
                                    TableBorder(bottom: BorderSide(width: 1)),
                              ),
                            );
                          },
                        );
